...
public class ReplicaStatsRequest extends Request {
    ...
    /**
     * Sets the limit to the number of replica stats records desired. If this
     * value is 0 there is no limit, but not all replica stats records may be
     * returned in a single request due to size limitations.
     *
